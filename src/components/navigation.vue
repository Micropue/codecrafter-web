<template>
    <s-navigation mode="rail">
        <!--抽屉顶部-->
        <s-icon-button slot="start" type="filled-tonal" title="个人">
            <s-icon>
        ...
        <!--抽屉导航0-->
        <s-navigation-item :selected="nowpath == 'home'" @click="$router.push('/')">
            <s-icon name="home" slot="icon"></s-icon>
            <div slot="text">首页</div>
        </s-navigation-item>
        <!--抽屉导航1-->
        <s-navigation-item :selected="nowpath == 'joinus'" @click="$router.push('/about/joinus')">
            ...
            <div slot="text">加入我们</div>
        </s-navigation-item>
        <!--抽屉导航2-->
        <s-navigation-item :selected="nowpath == 'community'" @click="$router.push('/community')">
            <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                <path
                    d="M240-400h320v-80H240v80Zm0-120h480v-80H240v80Zm0-120h480v-80H240v80ZM80-80v-720q0-33 23.5-56.5T160-880h640q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H240L80-80Zm126-240h594v-480H160v525l46-45Zm-46 0v-480 480Z">
                </path>
            </svg>
            <div slot="text">社区</div>
        </s-navigation-item>
        <!--抽屉导航3-->
        <s-navigation-item :selected="nowpath == 'blog'" @click="$router.push('/blog')">
            <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                <path
            ...
            <div slot="text">博客</div>
        </s-navigation-item>
        <s-navigation-item :selected="nowpath == 'projects'" @click="$router.push('/projects')">
            <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                <path
            ...
            <div slot="text">项目</div>
        </s-navigation-item>
        <s-navigation-item :selected="nowpath == 'chat'" @click="$router.push('/chat')">
            <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                <path
                    d="m720-120-56-56 63-64H560v-80h167l-63-64 56-56 160 160-160 160Zm-600 0v-600q0-33 23.5-56.5T200-800h480q33 0 56.5 23.5T760-720v203q-10-2-20-2.5t-20-.5q-10 0-20 .5t-20 2.5v-203H200v400h283q-2 10-2.5 20t-.5 20q0 10 .5 20t2.5 20H240L120-120Zm160-440h320v-80H280v80Zm0 160h200v-80H280v80Zm-80 80v-400 400Z">
                </path>
            </svg>
...
const nowpath = ref<any>('')
watch(() => $routes.name, () => {
    nowpath.value = $routes.name
})
</script>
